...
{colors.white}[ {colors.red}4 {colors.white}]\t{colors.bold}Line Graph
{colors.white}[ {colors.red}5 {colors.white}]\t{colors.bold}Bar graph
...
{colors.white}[ {colors.red}2 {colors.white}]\t{colors.bold}Bulk orders""")
    ...
    #delete a product
        ...
        item = input("Product name to be deleted : ")
        df = df.drop(df[df["Product"]==item].index)
